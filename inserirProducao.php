...
<?php
	...
	switch ($titulosMenuLateral) {	
		...
		case "cadastrarGenero":
			...
			require "inserirGenero.php";

		break;
			
		case "cadastrarDiretor":
			
			require "inserirDiretor.php";

		break;
			
		case "cadastrarPais":
			
			require "inserirPais.php";

		break;	
			
		case "cadastrarConsole":
			
			require "inserirConsole.php";

		break;
			
		case "cadastrarPublicadora":
			
			require "inserirPublicadora.php";

		break;
			
		case "cadastrarDesenvolvedora":
			
			require "inserirDesenvolvedora.php";
