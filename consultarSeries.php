...
<div id="consulta_container">
	...
	<div class='imgposter'>
		...
		<img src="../app_cinema_UC16_v4/img/series/titulo<?php echo "$id"; ?>/<?php echo "$imgnoticia"; ?>" alt="">
		
	</div>
	<div class='lista_filmes'>
	
		<div><h1><?php echo "$titulo"; ?></h1></div>
		<div><h2><?php echo "$elenco"; ?></h2></div>
	...
	<div class='gerenciar_filmes'>
		...
		if ($validador == 'off')
		{
			echo "<div><a href='validar.php?id=$id&validar=on&tipo=2'><i class='fas fa-check-square'></i><br> Validar
			</a></div>";
			
		}
		else
		{	
			echo "<div><a href='validar.php?id=$id&validar=off&tipo=2'><i class='fas fa-ban'></i><br>Desvalidar</a></div>";
		}
		?>
