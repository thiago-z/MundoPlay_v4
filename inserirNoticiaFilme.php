...
$tituloRelacionado = "SELECT * FROM filmes WHERE idfilmes = $relacionado";	
$tituloresultado = mysqli_query($strcon,$tituloRelacionado) or die(mysqli_error()."<br>Erro ao executar a inserção do filme relacionado");
	
	while($elemento = mysqli_fetch_array($tituloresultado))
 		{
   		$idFilmeRelacionado = $elemento['idfilmes'];
		}
...
$diretorio = '../app_cinema_UC16_v4/img/noticias/cinema/';
$pasta = 'titulo'.$idFilmeRelacionado;
