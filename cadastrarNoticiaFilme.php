...
<section>
	...
	<h2>Cadastrar nova notícia de filmes</h2>
	
	<form action="inserirNoticias.php?t=cadastrarNoticiaFilme" method="post" class="form_cadastro" enctype="multipart/form-data">
		...
		<div class="grupo">
          ...
          <?php
				...
				include_once('config/conectar.php');
					...
					$resultado = mysqli_query($strcon,$sql) or die(mysqli_error()."<br>Erro ao executar a inserção dos filmes");
